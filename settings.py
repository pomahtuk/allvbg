...
PROJECT_PATH = '/var/www/pman/data/www/allvbg_test'
...
MEDIA_ROOT = '/var/www/pman/data/www/allvbg_test/static/allvbg/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash if there is a path component (optional in other cases).
# Examples: "http://media.lawrence.com", "http://example.com/media/"
MEDIA_URL = 'http://allvbg.ru:3010/static/allvbg/'
...
TINYMCE_JS_URL = 'http://allvbg.ru:3010/static/tiny_mce/tiny_mce_src.js'
...
CACHES = {
    'default': {
        ...
        'LOCATION': '/var/www/pman/data/Django_test_cache',
        'TIMEOUT': 60,
        'OPTIONS': {
            'MAX_ENTRIES': 1000
        }
