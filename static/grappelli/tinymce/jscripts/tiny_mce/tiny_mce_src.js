	...
	var tinymce = {
		...
		_init : function() {
			...
			for (i=0; i<nl.length; i++) {
				v = nl[i].href;
				if (v) {
					// Host only value like http://geosite.com or http://geosite.com:8008
					if (/^https?:\/\/[^\/]+$/.test(v))
						v += '/';
...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			// IE has a bug where it remove geosite absolute urls to relative ones if this is specified
